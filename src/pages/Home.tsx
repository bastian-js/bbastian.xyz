...
import Card_AboutMe from "../components/Card_AboutMe";
    ...
    <>
      ...
      <div className="row">
        <div className="col">
          <Card_AboutMe
            title="about me"
            description="hi, i'm bastian, a 19 year old student from austria. i'm interested in programming, web development and design. i'm currently learning javascript/typescript and react. i'm also a big fan of the game minecraft and i'm playing it since 2017. i'm also a big fan of the game league of legends and i'm playing it since 2023."
          />
        </div>
      </div>
      <div className="row">
      ...
      <div className="row">
        ...
        <div className="col">
          <Card
            ...
            long_description="small giveaway bot to manage giveaways in discord. made using discord.js v14"
